	...
	"properties": {
		...
		"properties": {
			...
			"options":{			
			    "grid_columns":12,
                            "inputAttributes": {
                                "placeholder": "CVE-yyyy-nnnnn as allocated to you by CVEDB Security",
                            },
		    ...
		    "STATE": {
			"type": "string",
			"title": "STATE. Use DRAFT when you are working on the advisory. Move to READY when you want this published live and it will notify CVEDB Security.  Set to REVIEW if you would like any help from CVEDB Security reviewing this entry.",
			"default": "RESERVED",
			"enum": [
			    "RESERVED",
			    "DRAFT",
		...
		"properties": {
			...
			"items": {
			    "properties": {
				"refsource": {
				    "title": "refsource: (use 'CONFIRM' type for links to your official CVEDB public mailing list post)"
				},
				"url": {
		...
		"properties": {
			...
			"title":"Your CVEDB Email Address",
			"$ref": "/users/me/json",			
			"options":{
			    "hidden":true,
			    "grid_columns":12,
